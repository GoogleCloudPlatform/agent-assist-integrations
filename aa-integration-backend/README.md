...
4. [APIs](#apis)
    ...
    - [UI Connector](#ui-connector)
      - [JWT Registration APIs](#jwt-registration-apis)
      - [SocketIO APIs](#socketio-apis)
      - [Dialogflow Proxy APIs](#dialogflow-proxy-apis)
      - [Conversation Integration Key APIs](#conversation-integration-key-apis)
...
![Agent Assist Integration Services architecture diagram](images/structure.jpg)
...
![JWT registration workflow diagram](images/workflow0_jwt.png)
...
![Workflow event](images/workflow1_event.png)
...
![Workflow proxy](images/workflow2_proxy.png)
...
- **Conversation Integration Key APIs:** It receives clients' requests for creating, reading, and deleting `conversationIntegrationKey:conversationName` key-value pairs in Redis. This gives telephony platforms an alternative way to communicate a Dialogflow conversation ID to the front end.

### JWT Registration APIs
...
The Conversation Integration Key APIs receive clients' requests for creating, reading, and deleting `conversationIntegrationKey:conversationName` key-value pairs in Redis. This is optional and integration platform specific.
