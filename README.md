...
## Salesforce + Genesys CTI Integration

**Note:** This branch (`salesforce-genesys-cti-integration`) contains a non-GA Salesforce + Genesys CTI integration. For more details on setup and configuration, please refer to the [Genesys Integration Guide](./GENESYS_INTEGRATION_GUIDE.md).
